    ...
    <div>
        ...
        <h3>财务信息</h3>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password"  class="form-control" id="ban_name" name="ban_name" placeholder="开户名称">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">开户银行</label>
                <div class="col-sm-10">
                    <input type="password"  class="form-control" id="ban" name="ban" placeholder="开户银行">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">银行账号</label>
                <div class="col-sm-10">
                    <input type="password"  class="form-control" id="ban_no" name="ban_no" placeholder="银行账号">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">发票抬头</label>
                <div class="col-sm-10">
                    <input type="password"  class="form-control" id="invoice" name="invoice" placeholder="发票抬头">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">纳税人识别号</label>
                <div class="col-sm-10">
                    <input type="password"  class="form-control" id="taxes_no" name="taxes" placeholder="纳税人识别号">
                </div>
            </div>
