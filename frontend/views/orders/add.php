        ...
        <div>
            <form class="form-horizontal" id="form" method="post" id="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select onchange="change_customer();" name="customer_id" id="customer_id" class="form-control" style="width: 180px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select id="goods_id"  class="form-control" style="width: 180px;" onchange="add_goods();">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><span style="color:red;">*</span>已选商品：</label>
                    <div class="col-sm-10">
                        <table class="table" id="goods_data">
                            <tr>
                                <th>商品</th>
                                <th>价格</th>
                                <th>会员价格</th>
