...
<div>
    <form method="post" id="form">
        ...
        <div>
            <h4>促销参数：</h4>
            <p>数量：<input type="text" name="number" id="number"></p>
            <p>系数：<input type="text" name="coefficient" id="coefficient">（按照选择方案填写系数）</p>
        ...
        <div>
            ...
            <?php foreach($rank as $val): ?>
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="rank[]" value="<?php echo $val['rank_id'];?>">
